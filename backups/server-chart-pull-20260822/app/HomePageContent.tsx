...
export default function HomePageContent() {
  ...
  /** 첫 페인트는 가벼운 모드 — 통합·분석 즉시 마운트 시 메인 스레드 멈춤 방지 */
  ...
  useEffect(() => {
    const restore = () => startTransition(() => setUiMode(readStoredRailUiMode()));
        ...
        <div className={showRightStack ? 'grid' : 'grid grid--single'}>
          <div className="left-stack">
            <div className={`card panel-pad${uiMode === 'MERGED_ANALYSIS_DESK' ? ' card--merged-desk' : ''}`}>
              {pl.showChartCardHeader && uiMode !== 'MERGED_ANALYSIS_DESK' && (
