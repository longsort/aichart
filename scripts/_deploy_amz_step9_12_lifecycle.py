...
FILES = [
    ...
    "lib/aiMarketZone/lifecycleEngine.ts",
...
def main() -> int:
    ...
    try:
        ...
        run(ssh, f"grep -n 'enrichZonesWithLifecycle' {REMOTE}/lib/aiMarketZone/index.ts | head -2")
        ...
        out("[done] AMZ STEP9-12 lifecycle OK")
