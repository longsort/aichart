#!/usr/bin/env python3
"""Deploy AMZ STEP19-21 UI / perf / live validation."""
...
FILES = [
    "lib/aiMarketZone/explainEngine.ts",
    "lib/aiMarketZone/liveValidation.ts",
    "lib/aiMarketZone/packCache.ts",
    "lib/aiMarketZone/overlays.ts",
    "lib/aiMarketZone/buildPack.ts",
    "lib/aiMarketZone/types.ts",
...
def main() -> int:
    ...
    try:
        ...
        run(
            ssh,
            f"grep -n 'amzZonesToPriceLines\\|validateAmzLivePack\\|aiMarketZonePriceLines' "
            f"{REMOTE}/lib/aiMarketZone/overlays.ts "
            f"{REMOTE}/lib/aiMarketZone/buildPack.ts "
            f"{REMOTE}/app/components/mergedAnalysis/MergedAnalysisDeskView.tsx | head -10",
        )
