...
export const MERGED_DESK_EUROMAP_LAYERS: readonly EuromapLayerDef[] = [
  ...
  },
  {
    ...
    group: 'zone',
    label: '요만큼·이만큼 세트',
    hint: '시안과 동일 · 터치+요만큼+이만큼 세트 · TF별 채널구조 · A#FF2EB6',
    defaultHex: '#FF2EB6',
    onKey: 'chartMergedDeskThisMuchEnabled',
    idStarts: ['merged-desk-thismuch'],
  },
  {
  ...
  },
  {
    ...
    group: 'channel',
    label: '파랑빨강띠 · 롱통로 배경',
    hint: '상승(롱) 통로 면 색 · 농도. 차트설정·툴바에서 변경',
    defaultHex: '#22C55E',
    onKey: 'chartMergedDeskRbShowShort',
    hexKey: 'chartMergedDeskRbBullHex',
    opacityKey: 'chartMergedDeskRbFillOpacity',
    idIncludes: ['rb-short', 'rb-paint-bull', 'merged-desk-rb-fill', 'merged-desk-rb-bull'],
  },
  {
    id: 'rb-long',
    group: 'channel',
    ...
    opacityKey: 'chartMergedDeskRbFillOpacity',
    idIncludes: ['rb-long', 'rb-paint-bear', 'merged-desk-rb-bear'],
  },
  {
    id: 'rb-confluence',
    group: 'channel',
  ...
  },
  {
    ...
    hint: '롱·숏·대기·무색',
    defaultHex: '#FBBF24',
    onKey: 'chartAiCandleBorderEnabled',
  },
  {
    id: 'vol-rvol',
    group: 'volume',
  ...
  },
  {
    ...
    group: 'text',
    label: '200x 타점',
    hint: 'micro-SL·청산·FIRE',
    defaultHex: '#2DD4BF',
    onKey: 'chartMergedDeskScalp200Enabled',
    idStarts: ['merged-desk-scalp200', 'merged-desk-ai200'],
  },
  {
    id: 'practice-cue',
    group: 'text',
