...
import '../widgets/briefing_cards.dart';
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: MiniChartV4(
                      ...
                      tfKey: tfLabel,
                      bias: s.decisionTitle.contains('롱') ? 'LONG' : s.decisionTitle.contains('숏') ? 'SHORT' : null,
                      prob: s.confidence,
                    ),
                  ),
                ),
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 6),
                    BriefingCardPrices(vwap: s.vwap, s1: s.s1, r1: s.r1, zoneValid: s.zoneValid, zoneInvalid: s.zoneInvalid, zoneTargets: s.zoneTargets),
                    const SizedBox(height: 10),
