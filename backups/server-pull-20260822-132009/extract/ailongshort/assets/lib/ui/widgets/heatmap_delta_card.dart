  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            hasBase ? '가중치 변화(전/후)' : '가중치 변화(학습 결과)',
            style: const TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.bold),
          ),
          const SizedBox(height: 8),
          Text(
            hasBase
                ? '전=앱 시작 시점 / 후=현재. 숫자↑면 그 증거를 더 중요하게 봄.'
                : '1.00 이 기본값. 높을수록 더 중요하게 반영됨.',
        ...
        children: [
          ...
          if (hasBase)
            Padding(
              ...
              child: Text('전 ${base.toStringAsFixed(2)}  →  후 ${now.toStringAsFixed(2)}',
