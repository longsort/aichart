...
"""Hotfix: swing-anchor markers always visible on merged desk (no chip click)."""
...
def main() -> int:
    ...
    try:
        ...
        run(
            ...
            f"grep -n 'mergeAdvVolumeMarkersForDisplay' {REMOTE}/lib/mergedDeskAdvVolumeRead.ts | head -1",
        ...
        out("[done] swing-anchor always-visible hotfix OK")
