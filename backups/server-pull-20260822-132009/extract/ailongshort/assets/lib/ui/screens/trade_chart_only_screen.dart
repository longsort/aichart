                  ...
                  child: s == null
                      ...
                      : LayoutBuilder(
                          builder: (context, cts) {
                            ...
                            final lux = AdaptiveLuxTrendline.compute(candles: s.candles, tfKey: _tf);
                            final luxOv = luxTlToOverlay(r: lux, candles: s.candles);
                            final hasPlan = s.entry > 0 && s.stop > 0 && s.target > 0;
                            return Column(
                              children: [
                                Expanded(
                                  child: MiniChartV4(
                                    ...
                                    structureMarks: StructureMarksEngineFu.build(s.candles, maxMarks: 12),
                                    tfKey: _tf,
                                    bias: s.signalDir,
                                    prob: s.signalProb,
                                    showPlan: hasPlan || (s.showSignal && !s.locked && s.expectedRoiPct >= 25),
                                    entry: s.entry,
                                    stop: s.stop,
                                    target: s.target,
