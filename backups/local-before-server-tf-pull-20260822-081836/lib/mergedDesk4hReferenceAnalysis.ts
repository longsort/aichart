 ...
 * 차트에 분석을 붙여도 되는가.
 * - 일반: 심볼+TF 일치
 * - 통합·분석·독수리1호: 심볼 일치 + (차트TF 일치 | 15m 공동 분석)
 */
