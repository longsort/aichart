              ...
              child: Column(
                ...
                children: [
                  Row(children: [
                    ...
                    const Spacer(),
                    Text('?�음 마감: ${b.nextClose.hour.toString().padLeft(2,'0')}:${b.nextClose.minute.toString().padLeft(2,'0')}', style: TextStyle(color: t.text, fontSize: 12)),
                  ]),
                  ...
                  const SizedBox(height: 10),
                  _kv(t, '?�재가', b.nowPrice),
                  _kv(t, '마감 기�?', b.settleLevel),
                  _kv(t, '?�림(?�상)', b.pullback),
                  _kv(t, '목표1', b.target1),
                  _kv(t, '목표2', b.target2),
                  _kv(t, '무효', b.invalidation),
                  const SizedBox(height: 10),
                  Text('??마감 ?�공 ?�나리오', style: TextStyle(color: t.good, fontWeight: FontWeight.w900, fontSize: 12)),
                  const SizedBox(height: 6),
                  Text(b.primaryScenario, style: TextStyle(color: t.text, height: 1.2)),
                  const SizedBox(height: 10),
                  Text('?�️ ?�패/무효', style: TextStyle(color: t.bad, fontWeight: FontWeight.w900, fontSize: 12)),
                  const SizedBox(height: 6),
