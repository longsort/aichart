...
class EntryMarker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final label = watch
        ? '관망'
        : (isLong ? '롱' : (dir.toUpperCase().contains('SHORT') ? '숏' : dir.toUpperCase()));
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text('$label ${p.toStringAsFixed(0)}% · RR ${rr.toStringAsFixed(2)}', style: TextStyle(color: Colors.white.withOpacity(0.92), fontSize: 11, fontWeight: FontWeight.w900)),
                ],
              ),
            ),
          ),
