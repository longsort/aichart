#!/usr/bin/env python3
"""2026-08-31 패치: 실전AI존·AI ZONE 토글·완성본 캔들색 → /root/ailongshort + build + pm2."""
...
FILES = [
    ...
    # 실전AI zone + AI ZONE 마스터 토글
    "lib/mergedDeskPracticeAiPlan.ts",
...
def main() -> int:
    ...
    try:
        ...
        out("[done] 2026-08-31 patch deploy OK -> /root/ailongshort")
    finally:
        sftp.close()
        ssh.close()
    return 0
