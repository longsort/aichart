        ...
        children: [
          const Row(
            children: [
              ...
              SizedBox(width: 8),
              Text('?�데?�트', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800)),
            ],
          ),
          const SizedBox(height: 8),
          const Text('patch.json ?�용??붙여?�고 ?�용 (?�류 ???�동 롤백)', style: TextStyle(color: Colors.white54, fontSize: 12)),
          const SizedBox(height: 8),
          TextField(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    try {
                      ...
                      setState(() => _status = '?�용 ?�료');
                    } catch (_) {
                      setState(() => _status = '?�용 ?�패 ??롤백 처리');
                    }
                    await _refreshLog();
                  },
                  child: const Text('?�용'),
              ...
              Expanded(
                child: OutlinedButton(
                  onPressed: () async {
                    ...
                    setState(() => _status = ok ? '롤백 ?�료' : '롤백??백업 ?�음');
                    await _refreshLog();
                  },
                  child: const Text('롤백'),
                ),
