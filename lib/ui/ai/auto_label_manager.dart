...
/// AutoLabelManager
/// - TF density + label priority + collision resolver ë¥???ë²ˆì— ë¬¶ì–´??///   "?ë™?¼ë¡œ ê¹”ë”"?˜ê²Œ ë§Œë“œ??ë§¤ë‹ˆ?€.
///
/// ?¬ìš©:
/// 1) ?„ë³´ ?¼ë²¨?¤ì„ registerë¡?ì¶”ê?
/// 2) buildPlacements(viewport) ?¸ì¶œ
/// 3) ê²°ê³¼ placementë¡?Positioned ë°°ì¹˜ (hidden?´ë©´ skip)
class AutoLabel {
  final String id;
  final Rect desired;
  final Size size;
