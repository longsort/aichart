...
const MergedAnalysisDeskView = dynamic(
  () => import('./components/mergedAnalysis/MergedAnalysisDeskView'),
  {
    ssr: false,
    loading: () => (
      <div style={{ minHeight: 280, padding: 16, color: '#94a3b8', fontSize: 13 }}>
        통합·분석 데스크 올리는 중…
      </div>
    ),
  }
);
const Eagle1StructureDesk = dynamic(() => import('./components/eagle1/Eagle1StructureDesk'), {
  ssr: false,
});
...
/** 배포 후 1회: 앱 진입 기본을 통합·분석으로 (이후 사용자 선택 유지) */
const MERGED_DESK_LANDING_ONCE_KEY = 'ailongshort-merged-desk-landing-v1';
