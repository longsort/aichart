...
import 'package:fulink_pro_ultra/engine/decision_engine_v2.dart' show Decision;
...
class ConclusionBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bg = d.locked
        ...
        : (d.action.contains('상') || d.action.contains('롱'))
            ? const Color(0xFF1D3B31)
            : (d.action.contains('하') || d.action.contains('숏'))
