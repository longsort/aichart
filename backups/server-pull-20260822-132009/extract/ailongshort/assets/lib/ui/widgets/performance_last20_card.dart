  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text('최근 20개 성과', style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.bold)),
          ...
          _row('승률', '${winRate.toStringAsFixed(1)}%'),
          _row('평균 RR', avgRR.isNaN ? '--' : avgRR.toStringAsFixed(2)),
          _row('평균 근거점수', avgEvidence.isNaN ? '--' : avgEvidence.toStringAsFixed(2)),
        ],
      ),
    );
  }
