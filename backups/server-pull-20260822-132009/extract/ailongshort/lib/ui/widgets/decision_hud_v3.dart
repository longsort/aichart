...
class DecisionHudV3 extends StatelessWidget {
  ...
  String _titleKo() {
    ...
    if (dir == 'LONG') return '�??�정';
    if (dir == 'SHORT') return '???�정';
    return '관�?;
  }
  ...
  List<_EvRow> _evRows() {
    ...
    if (rows.isEmpty) {
      rows.add(_EvRow(text: '근거가 부족합?�다 (?�호 ?��?', value: base * 0.40));
        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              Text('?�정 ?�률', style: TextStyle(color: Colors.white.withOpacity(0.75), fontSize: 12)),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  s.signalKo.isNotEmpty ? s.signalKo : '근거 기반 ?�단',
                  maxLines: 1,
          ...
          Row(
            children: [
              ...
              Expanded(child: _MiniGauge(label: '구조?�치??, value: g2, accent: accent)),
              const SizedBox(width: 8),
              Expanded(child: _MiniGauge(label: '?�동???�수', value: g3, accent: accent)),
              const SizedBox(width: 8),
              Expanded(child: _MiniGauge(label: '?�동 ?�승', value: g4, accent: accent)),
            ],
          ),
