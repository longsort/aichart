        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              Text(decision == 'NO-TRADE' ? '매매금지' : decision, style: const TextStyle(color: Colors.white70, fontSize: 12)),
            ],
          ),
          const SizedBox(height: 10),
          _row('진입 가격', plan.entry),
          _row('손절 가격', plan.sl),
          ...
          Text('손익 비율 ~ ${plan.rr.toStringAsFixed(2)}', style: const TextStyle(color: Colors.white54, fontSize: 11)),
        ],
      ),
    );
  }
