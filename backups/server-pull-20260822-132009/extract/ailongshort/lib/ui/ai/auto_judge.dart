...
/// Auto Judge Engine
/// - ?ÖÎ†•: TradePlan + ?§ÏãúÍ∞?priceStream
/// - Ï∂úÎ†•: TradeOutcome (TP/SL/TIMEOUT)
/// - MAE/MFE ?êÎèô Ï∏°Ï†ï
///
/// Í∞ÑÎã® Î£?
/// - LONG: price <= sl => SL, price >= tp1/tp2/tp3 ?úÏ∞® hit (ÏµúÏ¢Ö tp3Î©?TP)
/// - SHORT: price >= sl => SL, price <= tp1/tp2/tp3
/// - TIMEOUT: ÏßÄ?ïÏãúÍ∞?Ï¥àÍ≥º ??TIMEOUT
class AutoJudge {
  final Duration timeout;
  final double beAfterTp1; // 0?¥Î©¥ ÎπÑÌôú?? TP1 ?àÌä∏ ??BE(ÏßÑÏûÖÍ∞Ä)Î°??¨ÏùÑ ?åÏñ¥?¨Î¶¨???µÏÖò(Î°? / ?åÏñ¥?¥Î¶¨???µÏÖò(??
  const AutoJudge({
