#!/usr/bin/env python3
"""Deploy AMZ fullscreen side card."""
...
FILES = [
    "app/components/mergedAnalysis/MergedDeskAiMarketZoneSideCard.tsx",
    "app/components/mergedAnalysis/MergedDeskAiMarketZoneSideCard.module.css",
