...
# keep WMS files outside Next project root (not deleted)
run("rm -rf /root/_ailongshort_wms_aside && mkdir -p /root/_ailongshort_wms_aside && "
    "if [ -d /root/ailongshort/_build_exclude ]; then mv /root/ailongshort/_build_exclude /root/_ailongshort_wms_aside/; fi; "
    "ls -la /root/_ailongshort_wms_aside")
