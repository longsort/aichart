...
const ANALYZE_FETCH_RETRY_DELAY_MS = 400;
/** 서버 폭주 시 무한 로딩 방지 — 타임아웃 후 에러·재시도 가능 */
const ANALYZE_CLIENT_TIMEOUT_MS = 32_000;
        ...
        <div className={showRightStack ? 'grid' : 'grid grid--single'}>
          <div className="left-stack">
            <div className={`card panel-pad${uiMode === 'MERGED_ANALYSIS_DESK' ? ' card--merged-desk' : ''}${useEagle1StructureDesk ? ' card--eagle1-desk' : ''}`}>
              ...
              >
                <div className="chart-wrap chart-wrap--eagle1-structure">
                  <ChartView
                    ref={chartSnapshotRef}
                    structureDeskLayout
                    symbol={symbol}
