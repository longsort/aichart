...
class CsvChipRowV1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // ???‘ì? ?”ë©´?ì„œ ?ìŠ¤???¤ë²„?Œë¡œ??ë°©ì?
          Wrap(
            spacing: 8,
            runSpacing: 6,
            crossAxisAlignment: WrapCrossAlignment.center,
            children: [
              Text('CSV/ìº”ë“¤ ì¹?, style: TextStyle(color: t.fg, fontSize: 12, fontWeight: FontWeight.w700)),
              Text('?„ìž¬ + ê³¼ê±° ë¹„êµ', style: TextStyle(color: t.muted, fontSize: 11)),
            ],
          ),
  ...
  Widget _chip(NeonTheme t, ChipItem c) {
    final bg = switch (c.tone) {
      ...
      // NeonTheme?ëŠ” panel???†ì–´??cardë¡??€ì²?      ChipTone.neutral => t.card.withOpacity(0.65),
    };
