    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('표본: $n', style: const TextStyle(fontSize: 10)),
          Text('승률: $winP%', style: const TextStyle(fontSize: 10)),
          Text('평균 이동: ${avgMoveP.toStringAsFixed(2)}%',
              style: const TextStyle(fontSize: 10)),
          Text('평균 RR: ${avgRR.toStringAsFixed(2)}',
              style: const TextStyle(fontSize: 10)),
        ],
      ),
    );
