...
import 'package:ailongshort/ui/screens/signals_screen_v82.dart';
import 'package:flutter/material.dart';
import 'package:ailongshort/ui/screens/ultra_home_screen.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.assistant), label: '?�랜'),
          BottomNavigationBarItem(icon: Icon(Icons.insights), label: '?�계'),
        ],
      ),
    );
  }
