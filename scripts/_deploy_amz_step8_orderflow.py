...
"""Deploy AI Market Zone STEP8 orderflow."""
...
FILES = [
    ...
    "lib/aiMarketZone/orderflowEngine.ts",
...
def main() -> int:
    ...
    try:
        ...
        run(ssh, f"grep -n 'orderflowEngine\\|ai-market-zone' {REMOTE}/lib/aiMarketZone/index.ts {REMOTE}/app/api/ai-market-zone/route.ts | head -6")
        ...
        out("[done] AMZ STEP8 orderflow OK")
