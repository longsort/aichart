#!/usr/bin/env python3
"""Hotfix: phone FS A factor checklist crash (undefined.slice)."""
...
FILES = [
    "app/components/eagle1Tapoint/TapointPhoneFullscreenShell.tsx",
...
def main() -> None:
    ...
    print("FACTOR_FS_HOTFIX deploy OK", flush=True)
