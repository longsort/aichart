"""Hotfix: restore mirageFaceLang state in MergedAnalysisDeskView."""
import os
import posixpath
import paramiko
...
REL = "app/components/mergedAnalysis/MergedAnalysisDeskView.tsx"
...
def main():
    ...
    try:
        ...
        print("\n[done] mirageFaceLang fix deployed")
    finally:
        sftp.close()
        ssh.close()
