...
export function buildMergedDeskRbAiZoneFacePack(
  ...
  if (htfTf) {
    ...
    overlays.push(
      rbNamedFaceZone({
        ...
        lo: htfP.lo,
        hi: htfP.hi,
        color: htfBear ? 'rgba(251,113,133,0.26)' : 'rgba(129,140,248,0.26)',
        extraClass: [
        ...
        bg: htfBear ? 'rgba(127,29,29,0.94)' : 'rgba(49,46,129,0.94)',
        confidence: 78,
      })
    );
  }
  ...
  overlays.push(
    rbNamedFaceZone({
      ...
      lo: ltfP.lo,
      hi: ltfP.hi,
      color: ltfBull ? 'rgba(74,222,128,0.26)' : 'rgba(248,113,113,0.24)',
      extraClass: [
        'merged-desk-rb-channel',
        'merged-desk-rb-ai-face',
      ...
      bg: ltfBull ? 'rgba(20,83,45,0.95)' : 'rgba(127,29,29,0.94)',
      confidence: 80,
    })
  );
