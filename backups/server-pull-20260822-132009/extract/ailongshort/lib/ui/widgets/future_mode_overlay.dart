...
///         reactionPct: reactionPct,       // 0~100 (지지/?�??반응 ?�률)
///         invalidPct: invalidPct,         // 0~100 (무효/?�패 ?�률)
...
class FutureModeOverlay extends StatelessWidget {
  ...
  /// Reaction probability (0~100) - e.g., "지지 반응 ?�률"
  final double reactionPct;

  /// Invalidation probability (0~100) - e.g., "무효 ?�률"
  final double invalidPct;

  /// Top-left label
  final String labelLeft;

  /// Optional subtitle (e.g., "3 ?�나리오 / 무효 ?�인 ?�용")
