#!/usr/bin/env python3
"""Deploy TF switch speed: no wipe, HTF recent-first, skip neighbor full, re-fit."""
...
def main() -> int:
    ...
    try:
        ...
        run(
            ssh,
            f"grep -n 'skipHtfFullUpgrade\\|tfOnlyMarketLoad\\|lengthJump' "
        ...
        sftp.close()
        ssh.close()
    out("[done] TF switch speed deploy OK -> /root/ailongshort")
    return 0
