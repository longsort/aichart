        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              Text('?¨Ï???ÏßÑÏûÖ??, style: TextStyle(color: t.warn, fontWeight: FontWeight.w900)),
            ],
          ),
          ...
          Row(
            children: [
              Expanded(child: _kv(t, 'ÎØ∏Ïã§???êÏùµ(USDT)', '${p.pnl>=0?'+':''}${fmt(p.pnl, f:4)}', pnlCol)),
              const SizedBox(width: 10),
          ...
          Row(
            children: [
              Expanded(child: _kv(t, '?òÎüâ(BTC)', fmt(p.qty, f:4), t.fg)),
              const SizedBox(width: 10),
              Expanded(child: _kv(t, 'Ï¶ùÍ±∞Í∏?USDT)', fmt(p.margin, f:4), t.fg)),
              const SizedBox(width: 10),
              Expanded(child: _kv(t, 'Ï¶ùÍ±∞Í∏?ÎπÑÏú®', '${fmt(p.marginRatePct, f:2)}%', t.fg)),
            ],
          ),
          const SizedBox(height: 10),
          ...
          Row(
            children: [
              Expanded(child: _kv(t, 'ÏßÑÏûÖÍ∞Ä', fmt(p.entry, f:1), t.fg)),
              const SizedBox(width: 10),
              Expanded(child: _kv(t, 'ÎßàÌÅ¨Í∞Ä', fmt(p.mark, f:1), t.fg)),
              const SizedBox(width: 10),
              Expanded(child: _kv(t, '?àÏÉÅ Ï≤?Ç∞Í∞Ä', fmt(p.liq, f:1), t.warn)),
            ],
          ),
          const SizedBox(height: 12),
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 10),
              Expanded(child: _btn(context, t, 'Ï∂îÍ?', Icons.add, () {})),
              const SizedBox(width: 10),
              Expanded(child: _btn(context, t, '?´Í∏∞', Icons.close, () {
          ...
          Text('???ÑÏû¨???úÌéò?¥Ìçº ?¨Ï????úÎ??àÏù¥?????îÎ©¥?ÖÎãà?? ?§Ï†ú Ï£ºÎ¨∏ ?∞Îèô?Ä ?µÏÖò?ºÎ°ú Î∂ÑÎ¶¨?©Îãà??',
