    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        children: [
          Row(
            children: [
              const Text('증거', style: TextStyle(fontSize: 13, color: Colors.white70, fontWeight: FontWeight.w800)),
              const SizedBox(width: 8),
              Text('$hit/$total', style: const TextStyle(fontSize: 14, color: Colors.white, fontWeight: FontWeight.w900)),
              const Spacer(),
              Text(hit >= 9 ? '고확률' : (hit >= 7 ? '준비' : (hit >= 5 ? '관심' : '대기')),
          ...
          Text(_open ? '상세(터치하면 접힘)' : '상세 보기(터치)',
