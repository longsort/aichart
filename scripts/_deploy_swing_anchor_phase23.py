...
"""Deploy swing-anchor volume Phase2 (stats) + Phase3 (whale confluence)."""
...
FILES = [
    ...
    "lib/mergedDeskSwingAnchorVolumeOutcomes.ts",

    "lib/mergedDeskSwingAnchorVolumeStats.ts",

    "lib/mergedDeskSwingAnchorWhaleConfluence.ts",

    "lib/swingAnchorVolumeStatsStore.ts",

    "lib/mergedDeskAdvVolumeRead.ts",

    "app/api/swing-anchor-volume-stats/route.ts",
...
def main() -> int:
    ...
    try:
        ...
        run(
            ...
            f"grep -n 'enrichSwingAnchorWithWhale' {REMOTE}/lib/mergedDeskAdvVolumeRead.ts | head -1",
        ...
        out("[done] swing-anchor phase2+3 OK -> /root/ailongshort")
