...
class _ModAdapterState extends State<ModAdapter> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: bg,
      appBar: AppBar(backgroundColor: bg, title: const Text("?�데?�터 ?�댑??), foregroundColor: Colors.white),
      body: Center(
