...
"""Deploy AI Dynamic Market Zone Engine chip (merged desk only)."""
...
FILES = [
    ...
    "lib/aiMarketZone/dataQuality.ts",

    "lib/aiMarketZone/evidenceCollector.ts",

    "lib/aiMarketZone/clusterEngine.ts",
...
def main() -> int:
    ...
    try:
        ...
        run(ssh, f"grep -n 'AI존엔진\\|buildAiMarketZonePack' {REMOTE}/app/components/mergedAnalysis/MergedAnalysisDeskView.tsx | head -5")
        ...
        out("[done] AI Market Zone chip OK -> /root/ailongshort")
