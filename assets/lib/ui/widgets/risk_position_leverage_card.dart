...
/// 5% 리스크 관리 · 진입 포지션 규모 · 손절 · 레버리지 (실시간)
/// 미래차트/메인 공용 — 엔진 데이터 기준 실시간 계산
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Container(
                    ...
                    child: Text(
                      '리스크 ${(riskPct * 100).toStringAsFixed(0)}% · 포지션 · 레버리지',
              ...
              Row(
                children: [
                  _tile('리스크금액', '${riskAmount.toStringAsFixed(1)} U', const Color(0xFF39FFB6)),
                  const SizedBox(width: 10),
                  _tile('수량', qty >= 0.01 ? qty.toStringAsFixed(4) : qty.toStringAsFixed(6), Colors.white),
                  const SizedBox(width: 10),
                  _tile('레버', '${effLeverage}x', const Color(0xFFFFD166)),
                ],
              ),
              const SizedBox(height: 10),
              Row(
                children: [
                  _tile('타점', entry.toStringAsFixed(0), Colors.white70),
                  const SizedBox(width: 8),
                  _tile('손절', sl.toStringAsFixed(0), const Color(0xFFFF4D6D)),
                  const SizedBox(width: 8),
                  _tile('목표', tp.toStringAsFixed(0), const Color(0xFF39FFB6)),
                  const SizedBox(width: 8),
