...
/// TF Bar + Ï¢ÖÍ?(ÎßàÍ∞ê) ?†Í? + ÎßàÍ∞ê Ïπ¥Ïö¥?∏Îã§??/// - ?∏Î? Î™®Îç∏(Candle/Tf) ?òÏ°¥ ?ÜÏù¥ String labelÎß?Î∞õÏùå
...
class _TFBarV2State extends State<TFBarV2> {
  ...
  Duration _tfToDuration(String tf) {
    switch (tf) {
      ...
      case '1M': return const Duration(days: 30); // Í∑ºÏÇ¨
        ...
        children: [
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Text(useClose ? 'Ï¢ÖÍ?' : 'Í≥†Ï?', style: const TextStyle(fontSize: 11)),
            ),
          ),
          const SizedBox(width: 8),
          // Countdown
          Container(
            ...
            child: Text('ÎßàÍ∞ê $ttl', style: const TextStyle(fontSize: 11, color: Colors.white70)),
          ),
        ],
      ),
    );
