...
/// S-15: 백그라운드 동기화(가능 범위) + 배터리/데이터 절약 옵션
class SyncManager {
  ...
  String get statusText {
    if (_lastSyncTime == null) return '동기화 대기';
    final d = _lastSyncTime!;
    return '마지막: ${d.month}/${d.day} ${d.hour}:${d.minute.toString().padLeft(2, '0')}';
  }
}
