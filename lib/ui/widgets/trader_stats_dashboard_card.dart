  ...
  Widget build(BuildContext context) {
    return _card(
      Column(
        ...
        children: [
          const Text('?¹ë¥ /?•ë¥  ?€?œë³´??, style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold)),
          const SizedBox(height: 10),

          _progressRow('?„ì²´ ?¹ë¥ ', winRate),
          const SizedBox(height: 10),

          _sectionTitle('ë°©í–¥ë³??¹ë¥ '),
          _miniRow('LONG', longStats, barColor: Colors.cyanAccent),
          _miniRow('SHORT', shortStats, barColor: Colors.orangeAccent),

          const SizedBox(height: 10),
          _sectionTitle('? ë¢°??êµ¬ê°„ë³??¹ë¥ '),
          _miniRow('?•ì‹  ??75', confHigh, barColor: Colors.greenAccent),
          ...
          const Text('???¹ë¥ ?€ WIN/(WIN+LOSS) ê¸°ì?. TIMEOUT/OPEN?€ ?œì™¸.',
