        ...
        children: [
          ...
          Row(
            children: [
              ...
              const Spacer(),
              Text('?πÎ•† ${(score.winRate * 100).toStringAsFixed(0)}%',
                  style: TextStyle(
                      color: muted,
                      fontSize: 12,
                      fontWeight: FontWeight.w900)),
          ...
          Text('Í≤∞Í≥º Î≤ÑÌäº???åÎü¨ ?ôÏäµ(?êÍ∏∞Î≥¥Ï†ï) Î°úÍ∑∏Î•??ìÏïÑÏ§?',
              style: TextStyle(
                  color: muted,
                  fontSize: 12,
          ...
          Wrap(
            ...
            children: [
              ...
              _btn(context, 'Î¶¨ÏÖã', onReset, subtle: true),
            ],
          ),
        ],
      ),
