...
function keepMirageDeskOverlay(o: OverlayItem): boolean {
  ...
  if (
    ...
    extra.includes('merged-desk-sl-zone') ||
    extra.includes('merged-desk-tp-zone') ||
    extra.includes('merged-desk-hot-glow-band') ||
    ...
    extra.includes('merged-desk-reacc-zone') ||
    extra.includes('merged-desk-reacc-line') ||
    ...
    extra.includes('merged-desk-thismuch') ||
    extra.includes('merged-ares-st-cloud') ||
  ...
  if (
    id.startsWith('merged-desk-thismuch-') ||
    extra.includes('merged-desk-thismuch')
  ) {
    return (
      kind === 'trendLine' ||
